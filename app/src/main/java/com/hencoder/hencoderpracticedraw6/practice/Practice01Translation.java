    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (mFlag) {
                    case 0:
                        imageView.animate().translationX(200).start();
                        if (mFlag == 0) mFlag++;
                        break;
                    case 1:
                        imageView.animate().translationX(0).start();
                        if (mFlag == 1) mFlag++;
                        break;
                    case 2:
                        imageView.animate().translationY(100).start();
                        if (mFlag == 2) mFlag++;
                        break;
                    case 3:
                        imageView.animate().translationY(0).start();
                        if (mFlag == 3) mFlag++;
                        break;
                    case 4:
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            imageView.animate().translationZ(50).start();
                        }
                        if (mFlag == 4) mFlag++;
                        break;
                    case 5:
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            imageView.animate().translationZ(0).start();
                        }
                        if (mFlag == 5) mFlag = 0;
                        break;
                }
