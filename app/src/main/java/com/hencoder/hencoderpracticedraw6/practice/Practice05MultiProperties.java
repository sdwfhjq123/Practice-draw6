    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mFlag) {
                    imageView.animate().scaleY(1).scaleX(1).alpha(1).translationX(600).rotation(360).start();
                } else {
                    imageView.animate().scaleY(0).scaleX(0).alpha(0).translationX(0).rotation(0).start();
                }
                mFlag = !mFlag;
            }
        });
